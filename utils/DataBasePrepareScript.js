    ...
    group.save(function(err, saved) {
      ...
      saveAll(rootGroups, function(results) {
        var otherGroups = [
          ...
          new Groups({
            name: 'Society for the Protection of chinchillas',
            parent: results[5]._id
          })
        ];
        saveAll(otherGroups, function(results2) {
          var addUsers = [
            new Users({
              ...
              name: 'admin',
              role: 'admin',
              groupId: results[1]._id
            }),
            new Users({
              email: 'msergey@isu.ru',
              password: 'msergey',
              name: 'sergey',
              role: 'student',
              groupId: results2[1]._id
            }),
            new Users({
              email: 'ivan@isu.ru',
              password: 'ivan',
            ...
            new Users({
              ...
              name: 'sergey',
              role: 'teacher',
              groupId: results2[3]._id
            }),
            new Users({
              email: 'fmaksim@isu.ru',
              password: 'fmaksim',
              name: 'maksim',
              role: 'student',
              groupId: results2[1]._id
            ...
            new Users({
              email: 'moderator@isu.ru',
              password: 'moderator',
              name: 'moderatorovich',
              role: 'admin',
              groupId: results2[4]._id
            }),
            new Users({
              email: 'lkolya@isu.ru',
              password: 'lkolya',
            ...
            new Users({
              ...
              name: 'blackovich',
              role: 'user',
              groupId: results[4]._id
            }),
            new Users({
              email: 'chinchilla@isu.ru',
              password: 'chinchilla',
              name: 'chinny',
              role: 'user',
              groupId: results2[5]._id
            }),
            new Users({
              email: 'unauth@isu.ru',
              password: 'unauth',
